...
class Buckets:
    # this is the hash used to assign buckets, floor division then multiplication by maxRadius
    def getKey(self, pt):
        return tuple([pt.x // self.maxRadius * self.maxRadius, pt.y // self.maxRadius * self.maxRadius])
